...
export default function LoginWithGoogle({ data, setData, avatar, sendOtp, showOTPVerification }) {
  ...
  return (
    <>
      ...
      <div className="p-6 rounded w-full max-w-lg mt-3 bg-gray-100">
        ...
        <div className="text-slate-700 mt-2 mb-4 flex items-center text-sm justify-center"><FcGoogle className="mr-2" /> You Are Seeing this because it's your First Time On AfiaCare</div>
