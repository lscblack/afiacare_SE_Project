...
function FAQ() {
  ...
  return (
    <div className='bg-[#ffffff] p-8' data-aos="fade-down">
        ...
        {faqData.map((faq, index) => (
          <div key={index} className='border rounded-lg overflow-hidden'>
            <div className='flex justify-between items-center p-4 bg-[#F1F5F9] cursor-pointer'
              ...
              data-aos="zoom-out" // Animation for the question
            >
            ...
            {activeIndex === index && (
              <div className='p-4 bg-white' data-aos="zoom-in"> {/* Animation for the answer */}
