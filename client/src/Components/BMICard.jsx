    ...
    <div>
      ...
      <div className='bg-white rounded p-8 cursor-pointer hover:translate-y-[-5px] duration-300'>
        <div className='flex justify-between gap-2 mb-4'>
          <div className='flex items-center justify-between border h-20 w-[50%] rounded-md relative'>
        ...
        <div className='relative h-[5px] bg-gray-200 my-4 '>
         ...
         <div className=''>
          <p className='text-gray-400 text-[12px] text-center mt-3 flex m-auto items-center justify-between gap-2'>
