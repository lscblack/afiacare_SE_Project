...
function Team() {
  ...
  return (
    <div className="p-10" data-aos="fade-up">
      <h2 className="aos text-[#39827a] text-3xl mb-4 text-center">
        {lang.ourTeam_title}
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {teamMembers.map((member, index) => (
          ...
          >
            <img
              src={member.img}
              alt={member.name} className="w-[100%] h-[280px] object-cover shadow-md hover:scale-105 duration-300 cursor-pointer rounded mb-4"
            />
            <h3 className="font-medium text-[18px] text-[#39827a]">
              {member.name}
            </h3>
            ...
            <div className="flex mt-2 space-x-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer" className="text-gray-600 bg-slate-100 p-2 rounded-full hover:text-[#0e76a8]"
              >
                <CiLinkedin size={22} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer" className="text-gray-600 bg-slate-100 p-2 rounded-full hover:text-[#E4405F]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer" className="text-gray-500 bg-slate-100 p-2 rounded-full hover:text-[#3b5998]"
              >
                <CiFacebook size={22} />
              </a>
            </div>
