...
const activities = [
  { id: 1, description: 'Ryan Reynolds', date: '2024-07-14', time: '10:00 AM' },
  { id: 2, description: 'Chris Hemsworth', date: '2024-07-15', time: '2:00 PM' },
  { id: 3, description: 'Stan Lee', date: '2024-07-16', time: '1:00 PM' },
];

function RecentActivities() {
  return (
    <div>
      <h2 className="text-[#39827a] font-medium text-[16px] mb-2">History</h2>
