...
const upcomingDonations = [
  { id: 1, center: 'City Blood Bank', type: 'Blood Donation', date: '20th Jul 2024', status: 'Scheduled' },
  { id: 2, center: 'Regional Blood Center', type: 'Plasma Donation', date: '22nd Jul 2024', status: 'Scheduled' },
  { id: 3, center: 'National Blood Service', type: 'Platelet Donation', date: '25th Jul 2024', status: 'Scheduled' },
  { id: 4, center: 'Hope Foundation Blood Drive', type: 'Blood Donation', date: '30th Jul 2024', status: 'Scheduled' },
];

function UpcomingDonations() {
  return (
    <div>
