                    ...
                    <tbody>
                      ...
                      {error ? (
                        ...
                        filteredUsers.map((user, index) => (
                          <tr key={user.id} className=" cursor-pointer" onClick={(e) => { e.stopPropagation(); handleMoreClick(user, index); }}>
                            ...
                            <td className="py-2 px-4 border-b border-gray-200 text-gray-500 relative">
                              <div className='cursor-pointer text-red-300' onClick={() => setIsDeleteModalOpen(true)}>
      ...
      {isDeleteModalOpen && selectedUser && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
            <div className="absolute text-gray-700 right-4 top-3" onClick={closeModal}>
              <span>X</span>
            </div>
            <p className="text-red-400"><strong>Danger zone:</strong> You are about to delete this user</p>
            <button className='bg-red-400 text-white p-3 rounded mt-3' onClick={() => deleteUser(selectedUser.id)}>Delete</button>
          </div>
        </div>
      )}
    </div>
